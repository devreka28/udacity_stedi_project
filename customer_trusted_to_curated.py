...
# Script generated for node Keep only distinct customer fields
SqlQuery0 = '''
select distinct serialNumber, sharewithpublicasofdate, birthday, registrationdate,sharewithresearchasofdate,customername,email,lastupdatedate, phone, sharewithfriendsasofdate from myDataSource
'''
Keeponlydistinctcustomerfields_node1721825188635 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"myDataSource":Joincustomertrustedandaccelerometerlanding_node1721825114474}, transformation_ctx = "Keeponlydistinctcustomerfields_node1721825188635")

# Script generated for node Customer Curated
CustomerCurated_node1721825294358 = glueContext.getSink(path="s3://udacitycoursero3/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerCurated_node1721825294358")
...
CustomerCurated_node1721825294358.writeFrame(Keeponlydistinctcustomerfields_node1721825188635)
job.commit()
